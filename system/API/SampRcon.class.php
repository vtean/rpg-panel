...
class SampRcon
{
     ...
     * @param float $gravity gravity double / float
     */
    ...
    public function jail($playerID)
    {
        return $this->rconSend("jail " . $playerID);
    }
     ...
     * @return String
     */
    public function kick($playerID, $reason)
    {
        return $this->rconSend("kick " . $playerID . $reason);
    }
