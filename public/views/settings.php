            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-sm-12 col-12">
                    <div class="tab-content" id="settingsTabContent">
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'overview'): ?> show active<?php endif; ?>">
                        ...
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'change-email'): ?> show active<?php endif; ?>">
                            <div class="dv-page-block">
                        ...
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'change-password'): ?> show active<?php endif; ?>">
                            <div class="dv-page-block">
                        ...
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'forum-name'): ?> show active<?php endif; ?>">
                            <div class="dv-page-block">
                        ...
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'email-login'): ?> show active<?php endif; ?>">
                            <div class="dv-page-block">
                                ...
                                <?php elseif ($user['MailLogin'] == 0): ?>
                                    ...
                                    <?php if (isset($_POST['activate_email_start'])): ?>
                                        ...
                                        <form method="post" class="dv-form mb-3">
                                            ...
                                            <button type="submit" name="activate_email_end" class="btn btn-success"><i
                                    ...
                                    <?php else: ?>
                                        <form method="post" class="mb-3">
                                            <input type="hidden" name="csrfToken"
                                                   value="<?php echo $_SESSION['csrfToken']; ?>"/>
                                            <button type="submit" name="activate_email_start" class="btn btn-success"><i
                                ...
                                <?php elseif ($user['MailLogin'] == 1): ?>
                                    <?php if (isset($_POST['deactivate_email_start'])): ?>
                                        <p>Email login helps to protect your account. Each time we detect a new login
                                            from an unknown IP Address, we will send a code to your email to ensure that
                                            it is you.</p>
                                        <p>We sent a code to your email. Please check and write it in the field below to
                                            continue.</p>
                                        <form method="post" class="dv-form mb-3">
                                            <input type="hidden" name="csrfToken"
                                                   value="<?php echo $_SESSION['csrfToken']; ?>"/>
                                            ...
                                            <button type="submit" name="deactivate_email_end" class="btn btn-danger"><i
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <p>* Follow <a href="">this link</a> to read more information about account security.
                                </p>
                            </div>
                        </div>
                        <div class="tab-pane fade<?php if ($data['urlParam'] == 'authenticator'): ?> show active<?php endif; ?>">
                            <div class="dv-page-block">
                                ...
                                <?php elseif ($user['GoogleStatus'] == 0): ?>
                                    <p>Google Authenticator is the best solution to protect your account. This app will
                                        generate an unique code every 30 seconds and you will have to enter it each time
                                        we detect a new login from an unknown IP Address. We strongly recommend you to
                                        activate this option.</p>
                                    <?php if (isset($_POST['activate_auth_start'])): ?>
                                        <p>Open the <strong>Google Authenticator</strong> app on your smartphone and scan the QR Code below or type manually the secret code.</p>
                                        <p class="text-danger">Remember or write somewhere the secret code. You will need it if you lose access to your phone.</p>
                                        <img src="<?php echo $_SESSION['dv_qr_code']; ?>" alt="QR Code">
                                        <p class="mt-3"><strong>Secret Code:</strong> <?php echo $_SESSION['dv_secret_code']; ?></p>
                                        <form method="post" class="dv-form mb-3">
                                            <input type="hidden" name="csrfToken"
                                                   value="<?php echo $_SESSION['csrfToken']; ?>"/>
                                            <div class="form-group">
                                            ...
                                            <button type="submit" name="activate_auth_end" class="btn btn-success"><i
                                                        class="fas fa-check"></i> Confirm
                                            </button>
                                        </form>
                                    <?php else: ?>
                                        <form method="post" class="mb-3">
                                            <input type="hidden" name="csrfToken"
                                                   value="<?php echo $_SESSION['csrfToken']; ?>"/>
                                            <button type="submit" name="activate_auth_start" class="btn btn-success"><i
                                                        class="fas fa-check"></i> Enable
                                            </button>
                                        </form>
                                    <?php endif; ?>
                                <?php elseif ($user['GoogleStatus'] == 1): ?>
                                    <?php if (isset($_POST['deactivate_auth_start'])): ?>
                                        ...
                                        <form method="post" class="dv-form mb-3">
                                            ...
                                            <button type="submit" name="deactivate_auth_end" class="btn btn-danger"><i
                                                        class="fas fa-times"></i> Disable
                                            </button>
                                        </form>
                                    <?php else: ?>
                                        ...
                                        <p class="text-danger">We do not recommend you to disable this option. Your account security is very important.</p>
                                    <?php endif; ?>
                                <?php endif; ?>
