<div class="dv-row">
    ...
    <div class="dv-secret-actions">
        <a href="<?php echo BASE_URL . '/groups/create'; ?>" class="dv-btn btn btn-success"><i
                    class="fas fa-user-plus"></i> <?php echo $data['lang']['create_group_txt']; ?></a>
    </div>
    <div class="dvTable">
        <table id="dreamTable">
            <thead>
            ...
            <?php foreach ($data['groups'] as $group): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo BASE_URL . '/groups/edit/' . $group['group_id']; ?>"
