<div class="dv-row">
    ...
    <?php if (isLoggedIn()): ?>
        <div class="dv-secret-actions">
            <a href="<?php echo BASE_URL . '/unbans/create'; ?>" class="dv-btn btn btn-success"><i
                        class="fas fa-plus-circle"></i> New Unban Request</a>
        </div>
    <?php endif; ?>
    <div class="dvTable">
        <table id="dvUnbansTable">
            ...
            <?php foreach ($data['unbans'] as $unban): ?>
                <tr>
                    <td>
                        <a href="<?php echo BASE_URL . '/users/profile/' . $unban['author_name']; ?>"><?php echo $unban['author_name']; ?></a>
                    </td>
                    <td>
                        <a href="<?php echo BASE_URL . '/users/profile/' . $unban['admin_name']; ?>"><?php echo $unban['admin_name']; ?></a>
                    </td>
                    ...
                    <td><a href="<?php echo BASE_URL . '/unbans/view/' . $unban['id']; ?>"><i
