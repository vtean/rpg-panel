                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 col-12">
                                <div class="dv-statistic">
                                    ...
                                    <div class="dv-block">
                                        <span class="dv-first"><a href="<?php echo BASE_URL . '/complaints'; ?>">Complaints</a></span>
                                        <p class="dv-second">
                                            <span class="text-warning" data-toggle="tooltip" data-placement="top"
            ...
            <div class="col-lg-4 col-sm-12 col-12">
                <div class="dv-widget">
                    ...
                    <div class="dv-widget-content">
                        <a href="<?php echo BASE_URL . '/groups'; ?>" class="dv-btn btn btn-primary btn-block"><i class="fas fa-users"></i> Manage Groups</a>
                        <a href="<?php echo BASE_URL . '/logs/panel'; ?>" class="dv-btn btn btn-info btn-block"><i class="fas fa-history"></i> Panel Logs</a>
                        <a href="<?php echo BASE_URL . '/logs/server'; ?>" class="dv-btn btn btn-success btn-block"><i class="fas fa-history"></i> Server Logs</a>
                    </div>
                </div>
