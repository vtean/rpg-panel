        ...
        <div class="row">
            <div class="col-lg-2 col-sm-12 col-12">
                <div class="nav flex-column nav-pills" id="dv-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="panel-adm-logs-tab" data-toggle="pill" role="tab" href="#panel-adm-logs"
                       aria-controls="panel-adm-logs" aria-selected="false"><i class="fas fa-user-shield"></i> Panel Admin Logs</a>
                    <a class="nav-link" id="panel-lead-logs-tab" data-toggle="pill" role="tab" href="#panel-lead-logs"
                       aria-controls="panel-lead-logs" aria-selected="false"><i class="fas fa-user-tie"></i> Panel Leader Logs</a>
            ...
            <div class="col-lg-10 col-sm-12 col-12">
                <div class="tab-content" id="dv-pills-tabContent">
                                ...
                                <?php if (!empty($data['pLeaderLogs'])): ?>
                                    <?php foreach ($data['pLeaderLogs'] as $log): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $log['date']; ?></td>
                                            <td>
                                                <a href="<?php echo BASE_URL . '/search/ip/' . $log['ip_address']; ?>" target="_blank"><?php echo $log['ip_address']; ?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                    ...
                    <div class="tab-pane fade" id="panel-player-logs" role="tabpanel" aria-labelledby="panel-player-logs-tab">
                        <div class="dvTable">
