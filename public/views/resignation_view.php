        ...
        <div class="row">
            <div class="col-lg-4 col-sm-12 col-12">
                <div class="dv-topic-info">
                    ...
                    <?php if ($_SESSION['user_id'] == $resignation['author_id'] || $data['isLeader'] == $resignation['faction_id'] || $data['fullAccess']): ?>
                        <div class="dv-topic-widget dv-actions">
                            <h4 class="dv-row-title">Resignation Actions</h4>
                            <div class="dv-action-buttons">
                                <div class="row">
                                    <?php if (strcasecmp($resignation['status'], 'Open') == 0 && ($data['isLeader'] == $resignation['faction_id'] || $data['fullAccess'])): ?>
                                        <div class="col">
            ...
            <div class="col-lg-8 col-sm-12 col-12">
                ...
                <?php if ($resignation['status'] != 'Closed'): ?>
                    <?php if ((isLoggedIn() && $_SESSION['user_id'] == $resignation['author_id']) || ($data['isLeader'] == $resignation['faction_id']) || $data['fullAccess']): ?>
