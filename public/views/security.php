<?php getHeader($data); ?>
    <div class="card col-md-5 login">
        <div class="card-body">
            ...
            <?php
                sendMail('gabrielbaraboi5@gmail.com', 'do-no-reply@dreamvibe.ro', 'test', 'test', 'test');
            ?>
                ...
                <div class="form-group login-group">
                    ...
                    <?php if (!empty($errors['secret_error'])): ?>
                        <div class="invalid-feedback">
                            <span><?php echo $errors['secret_error']; ?></span>
                        </div>
                    <?php endif; ?>
                </div>
                <p class="text-align-center"><?php echo $data['lang']['lost_secret_txt']; ?> <a
                            href=""><?php echo $data['lang']['here_txt']; ?></a></p>
                <button type="submit" class="login-btn"
                        name="authCheck"><?php echo $data['lang']['login_txt']; ?></button>
            </form>
        </div>
    </div>
<?php getFooter(); ?>