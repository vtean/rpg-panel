            ...
            <form action="" method="post" class="dv-form">
                ...
                <?php foreach ($data['questions'] as $question): ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="answer<?php echo $i; ?>" id="answer<?php echo $i; ?>"
                               class="form-control<?php if (!empty($errors['answer' . $i . '_error'])): ?> is-invalid<?php endif; ?>">
                        <?php if (!empty($errors['answer' . $i . '_error'])): ?>
                            <div class="invalid-feedback"><?php echo $errors['answer' . $i . '_error']; ?></div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
                <button type="submit" name="post_application" class="dv-btn btn btn-primary"><i
